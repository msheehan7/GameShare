...
function saveToDatabase(){
        ...
        var grandV = db.collection("grandV")
        // price: price,
    grandV.get().then(function(grandV){
            addGame(grandV);
            //gameOnPage(doc);
            })
        }
...
function addGame(grandV) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = grandV.data().name;
        consoleP.innerHTML = grandV.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (grandV.data().name === "the last of us" || grandV.data().name === "The Last of Us"){
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
            pic.src = "https://www.playerattack.com/imagery/2012/08/grandVOfUs-Cover.jpg";
            pic.classList.add("gamePicture");
            gamePicture.appendChild(pic);
            gameSection.appendChild(gamePicture);
    // halo 3: odst
         } else if (grandV.data().name === "halo 3: odst" || grandV.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (grandV.data().name === "super smash bros ultimate" || grandV.data().name === "super smash bros. ultimate" || grandV.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (grandV.data().name === "call of duty black ops 2" || grandV.data().name === "call of duty: black ops 2" || grandV.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // minecraft
        } else if (grandV.data().name === "minecraft" || grandV.data().name === "Minecraft"){     // minecraft
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                    ...
                    var question = confirm("Are you sure you want to trade this game for Grand Theft Auto V. There will be a $5 processing and handling fee for this transaction")
 ...
 function loadGames(){
        ...
        var grandV = db.collection("grandV")
        grandV.get().then(function(querySnapshot){
         querySnapshot.forEach(function(grandV){
