...
function saveToDatabase(){
        ...
        var sekiro = db.collection("sekiro")
        // price: price,
    sekiro.get().then(function(sekiro){
            addGame(sekiro);
            //gameOnPage(doc);
            })
        }
...
function addGame(sekiro) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = sekiro.data().name;
        consoleP.innerHTML = sekiro.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (sekiro.data().name === "the last of us" || sekiro.data().name === "The Last of Us"){
    ...
    // halo 3: odst
         } else if (sekiro.data().name === "halo 3: odst" || sekiro.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (sekiro.data().name === "super smash bros ultimate" || sekiro.data().name === "super smash bros. ultimate" || sekiro.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (sekiro.data().name === "call of duty black ops 2" || sekiro.data().name === "call of duty: black ops 2" || sekiro.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // minecraft
        } else if (sekiro.data().name === "minecraft" || sekiro.data().name === "Minecraft"){     // minecraft
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                    ...
                    var question = confirm("Are you sure you want to trade this game for Sekiro: Shadows Die Twice. There will be a $5 processing and handling fee for this transaction")
 ...
 function loadGames(){
        ...
        var sekiro = db.collection("sekiro")
        sekiro.get().then(function(querySnapshot){
         querySnapshot.forEach(function(sekiro){
