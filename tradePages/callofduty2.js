...
function saveToDatabase(){
        ...
        var callOf2 = db.collection("callOf2")
        // price: price,
        callOf2.get().then(function(callOf2){
            addGame(callOf2);
            //gameOnPage(doc);
            })
        }
...
function addGame(callOf2) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = callOf2.data().name;
        consoleP.innerHTML = callOf2.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (callOf2.data().name === "the last of us" || callOf2.data().name === "The Last of Us"){
    ...
    // halo 3: odst
         } else if (callOf2.data().name === "halo 3: odst" || callOf2.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (callOf2.data().name === "super smash bros ultimate" || callOf2.data().name === "super smash bros. ultimate" || callOf2.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (callOf2.data().name === "call of duty black ops 2" || callOf2.data().name === "call of duty: black ops 2" || callOf2.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // minecraft
        } else if (callOf2.data().name === "minecraft" || callOf2.data().name === "Minecraft"){     // minecraft
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                    ...
                    var question = confirm("Are you sure you want to trade this game for Call Of Duty Ops 2. There will be a $5 processing and handling fee for this transaction")
 ...
 function loadGames(){
        ...
        var callOf2 = db.collection("callOf2")
        callOf2.get().then(function(querySnapshot){
         querySnapshot.forEach(function(callOf2){
