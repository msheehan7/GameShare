...
function saveToDatabase(){
        ...
        var wolfenstein = db.collection("wolfenstein")
        // price: price,
    wolfenstein.get().then(function(wolfenstein){
            addGame(wolfenstein);
            //gameOnPage(doc);
            })
        }
...
function addGame(wolfenstein) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = wolfenstein.data().name;
        consoleP.innerHTML = wolfenstein.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (wolfenstein.data().name === "the last of us" || wolfenstein.data().name === "The Last of Us"){
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
            pic.src = "https://www.playerattack.com/imagery/2012/08/wolfensteinOfUs-Cover.jpg";
            pic.classList.add("gamePicture");
            gamePicture.appendChild(pic);
            gameSection.appendChild(gamePicture);
    // halo 3: odst
         } else if (wolfenstein.data().name === "halo 3: odst" || wolfenstein.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (wolfenstein.data().name === "super smash bros ultimate" || wolfenstein.data().name === "super smash bros. ultimate" || wolfenstein.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (wolfenstein.data().name === "call of duty black ops 2" || wolfenstein.data().name === "call of duty: black ops 2" || wolfenstein.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    var gameSection_id = wolfenstein.id
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                    ...
                    var question = confirm("Are you sure you want to trade this game for Wolfenstein: Youngblood. There will be a $5 processing and handling fee for this transaction")
                ...
                if(question){
                    ...
                    db.collection('wolfenstein').doc(wolfenstein.id).delete();
 ...
 function loadGames(){
        ...
        var wolfenstein = db.collection("wolfenstein")
        wolfenstein.get().then(function(querySnapshot){
         querySnapshot.forEach(function(wolfenstein){
