...
function saveToDatabase(){
        ...
        var residentE = db.collection("residentE")
        // price: price,
    residentE.get().then(function(residentE){
            addGame(residentE);
            //gameOnPage(doc);
            })
        }
...
function addGame(residentE) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = residentE.data().name;
        consoleP.innerHTML = residentE.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (residentE.data().name === "the last of us" || residentE.data().name === "The Last of Us"){
    ...
    // halo 3: odst
         } else if (residentE.data().name === "halo 3: odst" || residentE.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (residentE.data().name === "super smash bros ultimate" || residentE.data().name === "super smash bros. ultimate" || residentE.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (residentE.data().name === "call of duty black ops 2" || residentE.data().name === "call of duty: black ops 2" || residentE.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // minecraft
        } else if (residentE.data().name === "minecraft" || residentE.data().name === "Minecraft"){     // minecraft
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    var gameSection_id = residentE.id
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                    ...
                    var question = confirm("Are you sure you want to trade this game for Resident Evil 2. There will be a $5 processing and handling fee for this transaction")
                ...
                if(question){
                    ...
                    db.collection('residentE').doc(residentE.id).delete();
 ...
 function loadGames(){
        ...
        var residentE = db.collection("residentE")
        residentE.get().then(function(querySnapshot){
         querySnapshot.forEach(function(residentE){
