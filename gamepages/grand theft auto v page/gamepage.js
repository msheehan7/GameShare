            ...
            console.log(gameName);
                ...
                gameSection.id = gameSection_id
                        ...
                        //document.getElementById(gameSection.id).remove()
                                ...
                                var question = confirm("Are you sure you want to trade " + doc.data().name + " for Grand Theft Auto V. There will be a $5 processing and handling fee for this transaction")
