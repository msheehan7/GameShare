...
function addGame(halo3) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = halo3.data().name;
        consoleP.innerHTML = halo3.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (halo3.data().name === "the last of us" || halo3.data().name === "The Last of Us"){
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
            pic.src = "https://www.playerattack.com/imagery/2012/08/halo3OfUs-Cover.jpg";
            pic.classList.add("gamePicture");
            gamePicture.appendChild(pic);
            gameSection.appendChild(gamePicture);
    // halo 3: odst
         } else if (halo3.data().name === "halo 3: odst" || halo3.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (halo3.data().name === "super smash bros ultimate" || halo3.data().name === "super smash bros. ultimate" || halo3.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (halo3.data().name === "call of duty black ops 2" || halo3.data().name === "call of duty: black ops 2" || halo3.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // minecraft
        } else if (halo3.data().name === "minecraft" || halo3.data().name === "Minecraft"){     // minecraft
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                    ...
                    var question = confirm("Are you sure you want to trade this game for Halo 3: ODST. There will be a $5 processing and handling fee for this transaction")
                ...
                if(question){
                    ...
                    db.collection('halo3').doc(halo3.id).delete();
 ...
 function loadGames(){
        ...
        var halo3 = db.collection("halo3")
        halo3.get().then(function(querySnapshot){
         querySnapshot.forEach(function(halo3){
