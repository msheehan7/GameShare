...
function addGame(mineTrades) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = mineTrades.data().name;
        consoleP.innerHTML = mineTrades.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (mineTrades.data().name === "the last of us" || mineTrades.data().name === "The Last of Us"){
    ...
    // halo 3: odst
         } else if (mineTrades.data().name === "halo 3: odst" || mineTrades.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (mineTrades.data().name === "super smash bros ultimate" || mineTrades.data().name === "super smash bros. ultimate" || mineTrades.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (mineTrades.data().name === "call of duty black ops 2" || mineTrades.data().name === "call of duty: black ops 2" || mineTrades.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // minecraft
        } else if (mineTrades.data().name === "minecraft" || mineTrades.data().name === "Minecraft"){     // minecraft
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    var gameSection_id = mineTrades.id
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                    ...
                    var question = confirm("Are you sure you want to trade this game for MineCraft. There will be a $5 processing and handling fee for this transaction")
                ...
                if(question){
                    ...
                    db.collection('minetrades').doc(mineTrades.id).delete();
 ...
 function loadGames(){
        ...
        var mineTrades = db.collection("minetrades")
        mineTrades.get().then(function(querySnapshot){
         querySnapshot.forEach(function(mineTrades){
