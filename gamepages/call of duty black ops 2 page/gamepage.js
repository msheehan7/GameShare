            ...
            console.log(gameName);
                ...
                gameSection.id = gameSection_id
                        ...
                        //document.getElementById(gameSection.id).remove()
                                ...
                                var question = confirm("Are you sure you want to trade " + doc.data().name + " for Call Of Duty Black Ops 2. There will be a $5 processing and handling fee for this transaction")
