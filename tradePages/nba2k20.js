...
function saveToDatabase(){
        ...
        var nba2 = db.collection("nba2")
        // price: price,
    nba2.get().then(function(nba2){
            addGame(nba2);
            //gameOnPage(doc);
            })
        }
...
function addGame(nba2) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = nba2.data().name;
        consoleP.innerHTML = nba2.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (nba2.data().name === "the last of us" || nba2.data().name === "The Last of Us"){
    ...
    // halo 3: odst
         } else if (nba2.data().name === "halo 3: odst" || nba2.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (nba2.data().name === "super smash bros ultimate" || nba2.data().name === "super smash bros. ultimate" || nba2.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (nba2.data().name === "call of duty black ops 2" || nba2.data().name === "call of duty: black ops 2" || nba2.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // minecraft
        } else if (nba2.data().name === "minecraft" || nba2.data().name === "Minecraft"){     // minecraft
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                    ...
                    var question = confirm("Are you sure you want to trade this game for NBA 2K20. There will be a $5 processing and handling fee for this transaction")
                ...
                if(question){
                    ...
                    db.collection('nba2').doc(nba2.id).delete();
 ...
 function loadGames(){
        ...
        var nba2 = db.collection("nba2")
        nba2.get().then(function(querySnapshot){
         querySnapshot.forEach(function(nba2){
