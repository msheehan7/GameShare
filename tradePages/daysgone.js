...
function saveToDatabase(){
        ...
        // price: price,
        devilMay.get().then(function(devilMay){
            addGame(devilMay);
            //gameOnPage(doc);
            })
        }
...
function addGame(devilMay) {
    ...
    // changing inner.HTMLs
        nameP.innerHTML = devilMay.data().name;
        consoleP.innerHTML = devilMay.data().console;
...
// depending on the game name user inserts, picture shows up beside it 
    // the last of us
        if (devilMay.data().name === "the last of us" || devilMay.data().name === "The Last of Us"){
    ...
    // halo 3: odst
         } else if (devilMay.data().name === "halo 3: odst" || devilMay.data().name === "Halo 3: ODST"){  // halo 3: odst
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // super smash bros. ultimate
        } else if (devilMay.data().name === "super smash bros ultimate" || devilMay.data().name === "super smash bros. ultimate" || callOf2.data().name === "Super Smash Bros. Ultimate"){     // super smash bros ultimate
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // call of duty: black ops 2
        } else if (devilMay.data().name === "call of duty black ops 2" || devilMay.data().name === "call of duty: black ops 2" || callOf2.data().name === "Call of Duty: Black Ops 2"){     // call of duty black ops 2
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    // minecraft
        } else if (devilMay.data().name === "minecraft" || devilMay.data().name === "Minecraft"){     // minecraft
            var gamePicture = document.createElement("div");
            var pic = document.createElement("img");
    ...
    var gameSection_id = devilMay.id
    gameSection.id = gameSection_id
            ...
            //document.getElementById(gameSection.id).remove()
                ...
                if(question){
                    ...
                    db.collection('devilMay').doc(devilMay.id).delete();
 ...
 function loadGames(){
        ...
        var devilMay = db.collection("devilMay")
        devilMay.get().then(function(querySnapshot){
         querySnapshot.forEach(function(devilMay){
