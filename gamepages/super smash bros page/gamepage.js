            ...
            console.log(gameName);
                ...
                gameSection.id = gameSection_id
                        ...
                        //document.getElementById(gameSection.id).remove()
                                ...
                                var question = confirm("Are you sure you want to trade " + doc.data().name + " for Super Smash Bros. Ultimate. There will be a $5 processing and handling fee for this transaction")
                        console.log(user.uid)
                            ...
                            if(question){
                                ...
                                db.collection('users').doc(uid).collection('games').doc(doc.id).delete();
                                setTimeout(function(){ window.location.href = "confirmationPage.html"}, 300)
